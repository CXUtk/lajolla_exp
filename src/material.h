...
struct TraceFeature
{
    ComponentType componentType = ComponentType::Diffuse;
    Spectrum albedo = Spectrum(0, 0, 0);
    Real depth = 100;
    Vector3 normal = Spectrum(0, 0, 0);
};
...
struct BSDFSampleRecord {
    ...
    Spectrum albedo;
    ComponentType sampleType = ComponentType::Diffuse;
};
