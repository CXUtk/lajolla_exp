...
inline std::optional<LightLeSampleRecord> sample_point_direction_on_light_op::operator()(const Envmap& light) const
{
    // TODO
    return std::optional<LightLeSampleRecord>();
}
...
void pdf_point_direction_on_light_op::operator()(const Envmap& light) const
{
    // TODO
}

int get_medium_interface_light_op::operator()(const Envmap& light) const
{
    // TODO
    return -1;
}
